...
static site generators have been allowing devs like us to make websites from markdown since the
dawn of docpad.
...
And you're right, but it's bare bones and even Remix acknowledges in [their documentation](https://remix.run/docs/en/main/guides/mdx)
that it's better to use `mdx-bundler` to build content. This has lead to Colby and people like
Kent C. Dodds to make [creative solutions](https://kentcdodds.com/blog/how-i-built-a-modern-website-in-2021#mdx-compilation-with-mdx-bundler)
to solve this issue. These solutions work, and Colby's website source code is hosted on [his Github](https://github.com/colbywhite/colbywhite.dev).
...
people into one cohesive whole, to the overall support of the entire Remix community.
...
solution we wish we could have had at the start. And we'd like to make all the optimizations
...
<AuthorFooter imageSrc={mattAuthor} alt="Matt Hernandez">
  <>
    ...
    Hollywood was not all it cracked up to be. He's worked across all layers of
    the stack, but considers the front-end to be home and React to be the best
    UI library so far. You can find him on
    <a href="https://github.com/matt-hernandez" target="_blank">his Github</a>or on
    <a
